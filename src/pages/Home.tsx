...
const Home: React.FC = () => {
	...
	const pageTitle =
		"Walworking Technologies | Fire Safety, Services & Consulting in Nigeria";
	const pageDescription =
		"Your trusted partner for comprehensive fire safety services, solutions, and consulting in Nigeria. We protect lives and property with professional expertise and cutting-edge technology. Get a free consultation today.";
			...
			<section className="relative h-screen flex items-center justify-center overflow-hidden">
				...
				<div className="relative mt-8  z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
					...
					<p className="text-xl md:text-2xl text-secondary-200 mb-8 max-w-3xl mx-auto leading-relaxed animate-slideInRight">
						...
						protection and safety solutions. Protecting lives and
						property with professional expertise and cutting-edge
						technology.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow fade-in">
							...
							<p className="text-secondary-600 mb-6">
								Complete fire protection systems including
						...
						<div className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow fade-in">
							...
							<p className="text-secondary-600 mb-6">
								Comprehensive PPE solutions and safety equipment
						...
						<div className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-xl transition-shadow fade-in">
							...
							<p className="text-secondary-600 mb-6">
								Expert fire safety consulting, risk assessments,
								and compliance auditing for all facility types.
							</p>
							<Link
								to="/services"
								className="text-primary-600 font-medium hover:text-primary-700 transition-colors flex items-center justify-center"
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16 fade-in">
						...
						<p className="text-xl text-secondary-600 max-w-3xl mx-auto">
							We ensure that everything we do is governed by our
							core values, and that the service we provide is
							second to none.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						<div className="text-center fade-in">
							...
							<p className="text-secondary-600">
								We provide comprehensive service for fire
								fighting equipment including engineering design,
						...
						<div className="text-center fade-in">
							...
							<p className="text-secondary-600">
								Our fire alarm system services include system
						...
						<div className="text-center fade-in">
							...
							<p className="text-secondary-600">
								We supply top-quality Personal Protective
								Equipment designed to ensure safety and
						...
						<div className="text-center fade-in">
							...
							<p className="text-secondary-600">
								We ensure top-tier Quality Assurance processes
								to maintain the highest standards in our
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white">
						<div className="fade-in">
							...
							<p className="text-primary-100">
								Trusted by businesses across Nigeria for
						...
						<div className="fade-in">
							...
							<p className="text-primary-100">
								Decade of expertise in fire protection and
								safety consulting
							</p>
						</div>
						...
						<div className="fade-in">
							...
							<p className="text-primary-100">
								Round-the-clock emergency support and rapid
								response services
							</p>
						</div>
					</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12 fade-in">
						...
						<p className="text-xl text-secondary-600 max-w-4xl mx-auto leading-relaxed">
							Our Mission is to be 100% committed to developing
							and enhancing our services with relentless focus on
							safety, efficiency, swift response, technical
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="bg-secondary-50 p-8 rounded-xl fade-in">
							...
							<p className="text-secondary-600 mb-6 italic">
								"Walworking Technologies provided exceptional
								fire safety solutions for our manufacturing
								facility. Their team's professionalism and
							...
							<div className="flex items-center">
								...
								<div>
									...
									<p className="text-secondary-600 text-sm">
										Safety Manager, Lagos Industries
									</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-secondary-50 p-8 rounded-xl fade-in">
							...
							<p className="text-secondary-600 mb-6 italic">
								"Outstanding service and response time. Their
								maintenance program has ensured our fire systems
								are always operational. Highly recommend!"
							</p>
							<div className="flex items-center">
								<div className="w-12 h-12 bg-secondary-300 rounded-full mr-4"></div>
								<div>
									...
									<p className="text-secondary-600 text-sm">
										Facility Manager, Abuja Corporate Center
									</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-secondary-50 p-8 rounded-xl fade-in">
							...
							<p className="text-secondary-600 mb-6 italic">
								"Professional training programs and top-quality
								PPE supplies. Walworking has been our trusted
								partner for safety solutions."
							</p>
							<div className="flex items-center">
								<div className="w-12 h-12 bg-secondary-300 rounded-full mr-4"></div>
								<div>
									...
									<p className="text-secondary-600 text-sm">
										Operations Director, Port Harcourt Oil &
										Gas
									</p>
								</div>
							</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="fade-in">
						...
						<p className="text-xl text-secondary-300 mb-8 max-w-2xl mx-auto">
							Get a free consultation and comprehensive fire
							safety assessment from our experts today.
						</p>
