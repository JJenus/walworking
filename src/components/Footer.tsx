      ...
      <div className="bg-primary-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h3 className="text-xl sm:text-2xl font-bold mb-4">Stay Updated on Fire Safety</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {[
                { href: "https://facebook.com/walworkingtech", Icon: Facebook, label: "Facebook" },
                { href: "https://twitter.com/walworkingtech", Icon: Twitter, label: "Twitter" },
                { href: "https://linkedin.com/company/walworkingtech", Icon: Linkedin, label: "LinkedIn" },
                { href: "https://instagram.com/walworkingtech", Icon: Instagram, label: "Instagram" },
              ].map(({ href, Icon, label }) => (
                <a
                  key={label}
                  href={href}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg sm:text-xl mb-6">Quick Links</h4>
            <ul className="space-y-3 text-sm sm:text-base">
              {[
                ...
                <li key={label}>
                  <Link to={to} className="text-secondary-400 hover:text-white transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          {/* Services */}
          <div>
            <h4 className="font-bold text-lg sm:text-xl mb-6">Our Services</h4>
            <ul className="space-y-3 text-sm sm:text-base">
              {[
                ...
                <li key={service} className="text-secondary-400">
                  {service}
                </li>
              ))}
            </ul>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-bold text-lg sm:text-xl mb-6">Contact Information</h4>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              {[
                ...
                <Link key={label} to={to} className="text-secondary-400 hover:text-white transition-colors text-sm">
                  {label}
                </Link>
              ))}
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-secondary-800">
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 opacity-60">
                {["ISO 9001:2008", "ISO 14001:2004", "OHSAS 18001", "IMO: ISM Code"].map((cert) => (
                  <div key={cert} className="text-secondary-600 font-bold text-sm">
                    {cert}
                  </div>
                ))}
              </div>
