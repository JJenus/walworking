						...
						>
							<div class="text-center text-lg-start">
								<div class="mb-4 text-white-stable">
									<small class="text-uppercase ls-lg"
										>WalWorking Technologies</small
									>
									<h1
										class="mb-3 mt-3 display-3 text-white-stable"
									>
										Fire Service, Construction and
										Consulting.
									</h1>
									<p class="lead mb-0">
										Welcome to Wal Working Technologies
										Limited – Your Trusted Partner in Fire
										Protection and Safety Solutions in
										Nigeria.
									</p>
								</div>
								...
								<div data-cue="zoomIn">
									<h2 class="lh-base h4">
										<a
											href="portfolio-single.html"
											class="text-reset"
											>AI avatar application</a
										>
									</h2>
									<p
										class="mb-0 text-body-tertiary fw-medium"
									>
										Web Development
									</p>
								</div>
					...
					<div class="col-xl-5 col-md-7" data-cue="fadeIn">
						<div class="mb-xl-7 mb-5">
							...
							<p class="mb-0 text-body">
								Projects deep and still going deeper in the
								mobile & web app development space. From A to Z
								of building beautiful apps, we do everything
								in-house.
							</p>
						</div>
					</div>
								...
								<div class="d-lg-flex">
									...
									<div class="ms-lg-5 mt-4 mt-lg-0">
										<div class="mb-4">
											<h3>UX/UI Design</h3>
											<p class="mb-0">
												Vivamus eu est eget ipsum
												molestie commodo in id eratam
												scelerisque vehicula felis,
												vitae volutpat diam efficitur
												id.
											</p>
										</div>
								...
								<div class="d-lg-flex">
									...
									<div class="ms-lg-5 mt-4 mt-lg-0">
										<div class="mb-4">
											...
											<p class="mb-0">
												Fusce ultrices accumsan
												porttitor orbi at libero
												vestibulum viverra elit nisi,
												efficitur fringilla sem
												consectetur ac.
											</p>
										</div>
								...
								<div class="d-lg-flex">
									...
									>
										<svg
											...
											height="24"
											fill="currentColor"
											class="bi bi-palette2 text-warning"
											viewBox="0 0 16 16"
										>
											<path
									...
									<div class="ms-lg-5 mt-4 mt-lg-0">
										<div class="mb-4">
											...
											<p class="mb-0">
												Proin maximus sollicitudin urna
												mattis odio uisque elementum
												ullamcorper sagittis onec sit
												amet interdum libero.
											</p>
										</div>
								...
								<div class="d-lg-flex">
									...
									>
										<svg
											...
											height="24"
											fill="currentColor"
											class="bi bi-window-dock text-info"
											viewBox="0 0 16 16"
										>
											<path
									...
									<div class="ms-lg-5 mt-4 mt-lg-0">
										<div class="mb-4">
											...
											<p class="mb-0">
												Duis sapien neque, malesuada a
												sem porttitor, imperdiet euismod
												nibh ras porta leo et diam
												dictum, et fringilla lorem
												tristique.
											</p>
										</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-6 offset-xl-3 col-md-12 col-12">
						<div class="text-center mb-xl-7 mb-5" data-cue="fadeIn">
							<small class="text-uppercase ls-md fw-semibold"
								>modern tech stack</small
							>
							<h2 class="my-3">Building the web</h2>
							<p class="mb-0 text-body">
								We work with cutting-edge technologies designed
								to solve your product requirements. Focus on
								finding solutions for your business needs while
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1 col-md-12 col-12">
						<div
							class="row row-cols-lg-5 row-cols-md-4 row-cols-2 justify-content-center g-5"
						>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-1.svg"
										alt="logo"
									/>
								</figure>
							</div>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-2.svg"
										alt="logo"
									/>
								</figure>
							</div>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-3.svg"
										alt="logo"
									/>
								</figure>
							</div>
							...
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-5.svg"
										alt="logo"
									/>
								</figure>
							</div>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-6.svg"
										alt="logo"
									/>
								</figure>
							</div>
							...
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-7.svg"
										alt="logo"
									/>
								</figure>
							</div>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-8.svg"
										alt="logo"
									/>
								</figure>
							</div>
							<div class="col" data-cue="slideInDown">
								<figure class="text-center mb-0">
									<img
										src="/assets//images/brand-logo/brand-logo-9.svg"
										alt="logo"
									/>
								</figure>
							</div>
					...
					>
						<div class="mb-4">
							<small class="text-uppercase ls-md fw-semibold"
								>who we are</small
							>
							<h2 class="h1 mt-4 mb-3">
								Believes in the power of creative strategy.
							</h2>
							<p class="mb-3">
								We are a web design and development agency. We
								specialise in bridging the gap between our
								clients and their goals.
							</p>
							<p class="mb-0">
								Consequat mauris nunc congue nisi vitae suscipit
								tellus mauris a. Amet mattis vulputate enim
				...
				<div class="row border-top border-bottom">
					...
					>
						<div class="text-center py-lg-5 p-4">
							...
							<h4>Expert team</h4>
							<p class="mb-0">
								Vivamus eget neque lacus. Pellentesque egauris
								ex.
							</p>
						</div>
					</div>
					...
					<div class="col-md-4" data-cue="zoomIn">
						<div class="text-center py-lg-5 p-4">
							...
							<h4>10 Year Exp.</h4>
							<p class="mb-0">
								Pellen tesque eget, mauris lorem iupsum neque
								lacus.
							</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 offset-lg-3" data-cue="fadeIn">
						<div class="text-center mb-xl-7 mb-5">
							...
							<p class="mb-0">
								At least, not exclusively. Reduced recruiting
								costs, more efficient and effective
								communication.
							</p>
						</div>
					</div>
					...
					<div class="row g-5 flex-nowrap pb-4 pb-lg-0 me-5 me-lg-0">
						...
						>
							...
							<h3 class="my-3 lh-base h4">
								<a href="blog-single.html" class="text-reset"
							...
							>
								...
								<div class="ms-3">
									<span class="fs-6">Nov 26, 2023</span>
								</div>
							</div>
						</article>
						<article
						...
						>
							...
							<a
								href="#!"
								class="badge bg-warning-subtle text-warning-emphasis rounded-pill text-uppercase"
								>Business</a
							>
							<h3 class="my-3 lh-base h4">
								<a href="blog-single.html" class="text-reset"
									>Block Template for startup business</a
								>
							</h3>
							<div
								class="d-flex align-items-center justify-content-between mb-3 mb-md-0"
							>
								...
								<div class="ms-3">
									<span class="fs-6">Nov 21, 2023</span>
								</div>
							</div>
						</article>
						<article
						...
						>
							...
							<a
								href="#!"
								class="badge bg-success-subtle text-success-emphasis rounded-pill text-uppercase"
								>Digital</a
							>
							<h4 class="my-3 lh-base">
								<a href="blog-single.html" class="text-reset"
									>The power of doing nothing at all</a
								>
							</h4>
							<div
								class="d-flex align-items-center justify-content-between mb-3 mb-md-0"
							>
								...
								<div class="ms-3">
									<span class="fs-6">Nov 23, 2023</span>
								</div>
							</div>
						</article>
					</div>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1 col-md-12">
						<div class="row align-items-center g-5">
							...
							>
								<div class="me-xl-7">
									<div class="mb-5">
										...
										<p class="mb-0">
											Book a free consultation call with
											one of our experts and get help with
											your next moves. It's always good to
							...
							<div
								class="col-lg-6 col-12 order-lg-2"
								data-cue="slideInRight"
							>
								<div class="card shadow-sm">
									<div class="card-body">
										<form
											class="row needs-validation g-3"
											novalidate
										>
											<div class="col-lg-12">
												<div class="mb-3">
