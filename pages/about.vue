<template>
	<div>
										...
										<li class="d-flex mb-3">
											<span>
												<svg
													...
													height="16"
													fill="currentColor"
													class="bi bi-check-circle-fill text-primary opacity-75"
													viewBox="0 0 16 16"
												>
													<path
				...
				<div class="row">
					<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
						<div class="text-center mb-xl-7 mb-5">
							<h2 class="mb-0">
								Our principles that keep us moving forward
								together.
							</h2>
						</div>
					</div>
		...
		<section class="my-9">
			<div class="container">
				<div
					class="row line-pattern bg-primary-gradient rounded-3 p-7 g-0"
				>
