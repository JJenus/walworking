<template>
	<div>
		...
		<section class="py-lg-9 my-lg-10">
			<div
				class="container bg-light rounded-3 d-flex align-items-center pb-6 pb-md-0"
			>
				<div class="row align-items-center">
						...
						<div class="position-relative p-lg-6 p-4">
							<div class="mb-4">
								...
								<p class="mb-0 me-xl-7">
									...
									our experts and get help with your next
									moves. It's always good to talk to an
									expert. It's free!
								</p>
							</div>
					...
					<div
						class="col-xxl-3 col-xl-4 col-lg-5 col-12 position-lg-absolute start-50 ms-lg-6"
					>
								...
								>
									<div class="col-lg-12">
										<div class="mb-3">
											...
											<p class="mb-0">
												Schedule a short 20-min
												discovery call and get a look
												inside the way we design,
												develop and scale websites.
											</p>
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<label
											for="ServiceFirstnameInput"
											class="form-label"
										>
											First Name
