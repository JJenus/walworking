				...
				<div class="row">
					<div class="col-xxl-5 col-lg-5 col-md-7">
						<div class="mb-7 mb-xl-0">
							<div class="mb-4">
								<a href="/" class="text-primary fs-4 fw-bold">
									<img
										width="40"
										src="/assets/images/logo/logo-w.png"
										alt="logo"
										class="text-inverse img-auto"
									/>
					...
					<div
						class="offset-xxl-1 col-xxl-6 col-lg-6 offset-md-1 col-md-4"
					>
							...
							<div class="dropdown">
								...
								>
									<li>
										...
										>
											<i
												class="bi theme-icon bi-sun-fill"
											></i>
									...
									<li>
										...
										>
											<i
												class="bi theme-icon bi-moon-stars-fill"
											></i>
									...
									<li>
										...
										>
											<i
												class="bi theme-icon bi-circle-half"
											></i>
